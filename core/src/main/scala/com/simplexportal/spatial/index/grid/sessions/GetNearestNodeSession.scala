...
import com.simplexportal.spatial.index.grid.tile.actor.{TileIdx, TileIndexEntityIdGen, GetInternalNearestNodeResponse => TileReply}
...
import com.simplexportal.spatial.index.protocol.{GridNearestNode, GridRequest}
